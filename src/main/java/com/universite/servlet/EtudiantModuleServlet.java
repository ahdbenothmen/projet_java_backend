...
protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    // DELETE /api/etudiant/modules?moduleId=X → désinscrire l'étudiant d'un module
@Override
protected void doDelete(HttpServletRequest req, HttpServletResponse resp)
    ...
    // Extraire le CIN depuis le token JWT
    private String getCinFromToken(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            // Le token contient l'email → chercher le CIN en BD
